    ...
    <>
      <div className="flex gap-5">
        <button
          ...
          className="font-semibold text-regular py-2 px-7 h-[2.75rem] inline-block rounded-md bg-warning disabled:bg-grey-400"
        >
          Exit
        </button>
        {ordertype === "order" ? (
          ...
          <button
            ...
            onClick={handleModal}
            className="font-semibold text-regular py-2 h-12 px-7 inline-block rounded-md bg-black disabled:bg-grey-400"
          >
            Partial Exit
          </button>
        )}
